Привет! Это мой проект по созданию собственного облачного сервера на Linux-системе с дальнейшей реализацией мультиплатформенного IPSec с помощью StrongSwan.
